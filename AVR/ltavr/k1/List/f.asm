...
; 0000 0023 // Func7=In Func6=Out Func5=Out Func4=Out Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 0024 // State7=T State6=0 State5=0 State4=0 State3=0 State2=0 State1=0 State0=0
...
; 0000 0087            char a[10]={0b01111110,0b00000110,0b01101101,0b01001111,0b00010111,0b01011011,0b01111011,0b00001110,0b01111111,0b01011111};
; 0000 0088            int y=0b00001110;
; 0000 0089            int x=0b00001110;
; 0000 008A            int z=0b00001110;
; 0000 008B            int i;
; 0000 008C 
; 0000 008D            for(i=0;i<10;i++){
	SBIW R28,18
	LDI  R24,16
	LDI  R26,LOW(2)
	LDI  R27,HIGH(2)
