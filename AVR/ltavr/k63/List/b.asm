...
;void usart_trans(unsigned char i){
; 0000 001D void usart_trans(unsigned char i){
...
; 0000 0074 // USART Receiver: Off
; 0000 0075 // USART Transmitter: On
; 0000 0076 // USART Mode: Asynchronous
; 0000 0077 // USART Baud Rate: 57600
; 0000 0078 UCSRA=0x00;
	OUT  0xB,R30
; 0000 0079 UCSRB=0x08;
	LDI  R30,LOW(8)
	OUT  0xA,R30
; 0000 007A UCSRC=0x86;
	LDI  R30,LOW(134)
	OUT  0x20,R30
; 0000 007B UBRRH=0x00;
	LDI  R30,LOW(0)
	OUT  0x20,R30
; 0000 007C UBRRL=0x08;
	LDI  R30,LOW(8)
	OUT  0x9,R30
; 0000 007D 
