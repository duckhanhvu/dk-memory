...
_0x3:
	...
	.DB  0xFE,0xF6,0xEE,0xFE,0x9C,0xFC,0x9E,0x8E
...
; 0000 001E  {
	...
	.CSEG
_phim:
; 0000 001F   row=0b0000;
	CLR  R12
	CLR  R13
; 0000 0020   PORTA=row;
	OUT  0x1B,R12
; 0000 0021   if(PINA==0b00001111)
	IN   R30,0x19
	CPI  R30,LOW(0xF)
	BRNE _0x4
; 0000 0022   key=16;
...
; 0000 0028     PORTA=row;
	OUT  0x1B,R12
; 0000 0029     if(PINA.0==0) key=i;
	SBIS 0x19,0
	MOVW R4,R8
; 0000 002A     if(PINA.1==0) key=4+i;
	SBIC 0x19,1
	RJMP _0xA
	MOVW R30,R8
	ADIW R30,4
	MOVW R4,R30
; 0000 002B     if(PINA.2==0) key=8+i;
_0xA:
	SBIC 0x19,2
	RJMP _0xB
	MOVW R30,R8
	ADIW R30,8
	MOVW R4,R30
; 0000 002C     if(PINA.3==0) key=12+i;
_0xB:
	SBIC 0x19,3
	RJMP _0xC
	MOVW R30,R8
	ADIW R30,12
	MOVW R4,R30
; 0000 002D     row=(row<<1)+0b00010000;
_0xC:
	MOVW R30,R12
	LSL  R30
	ROL  R31
...
; 0000 0046 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0047 DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(240)
	OUT  0x1A,R30
; 0000 0048 // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0049 PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (1<<PORTA3) | (1<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(15)
	OUT  0x1B,R30
; 0000 004A 
...
; 0000 0059 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(15)
	OUT  0x11,R30
; 0000 005A // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=0 Bit1=0 Bit0=0
