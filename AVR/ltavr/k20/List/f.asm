...
; 0000 002A PORTB=0b11111111;
	OUT  0x18,R30
; 0000 002B DDRB=0b00001111;
	LDI  R30,LOW(15)
	OUT  0x17,R30
; 0000 002C 
...
; 0000 0086         int y=0b11111111;
; 0000 0087         int x=0b11100111;
; 0000 0088         if(PORTB==x){
	SBIW R28,4
	LDI  R30,LOW(231)
	ST   Y,R30
	LDI  R30,LOW(0)
...
; 0000 0089            delay_ms(5);
	...
	ST   -Y,R30
	CALL _delay_ms
; 0000 008A            if(PORTB==x){
	RCALL SUBOPT_0x0
	BRNE _0x7
; 0000 008B            if(PORTB==x+0b00000001){
	IN   R30,0x18
	MOV  R26,R30
	LD   R30,Y
	LDD  R31,Y+1
