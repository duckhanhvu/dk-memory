...
; 0000 001E void uart_char_tx(unsigned char chr){

	.CSEG
_uart_char_tx:
; 0000 001F if(UCSRA==0x20){
;	chr -> Y+0
	IN   R30,0xB
	CPI  R30,LOW(0x20)
	BRNE _0x3
