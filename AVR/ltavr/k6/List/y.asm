...
; 0000 0087        int i;
; 0000 0088        //int x=0b10000000;
; 0000 0089        int y=0b00000001;
; 0000 008A        int z=0b00000001;
; 0000 008B        int j;
; 0000 008C        int n=7;
...
_0x9:
; 0000 009A 
; 0000 009B            int x=0b10000000;
; 0000 009C            for(i=0;i<n;i++){
	SBIW R28,2
	LDI  R30,LOW(128)
	RCALL SUBOPT_0x0
;	i -> Y+10
