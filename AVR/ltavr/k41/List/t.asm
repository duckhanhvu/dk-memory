...
_0x3:
	...
	.DB  0x7D,0x7,0x7F,0x6F,0x3F,0x6,0x5B,0x4F
...
;static unsigned char key[4][4]={0b00111111,0b00000110,0b01011011,0b01001111,
...
; 0000 0021 unsigned int quet_phim(void){

	.CSEG
_quet_phim:
; 0000 0022 
; 0000 0023     int a[4]={0b11111110,0b11111101,0b11111011,0b11110111};
; 0000 0024     int dong;
; 0000 0025 
; 0000 0026     PORTD=0b11111111;
	SBIW R28,8
	LDI  R30,LOW(254)
	ST   Y,R30
	LDI  R30,LOW(0)
...
;	dong -> R16,R17
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 0027     for(dong=0;dong<4;dong++){
	__GETWRN 16,17,0
_0x5:
	__CPWRN 16,17,4
	BRLT PC+3
	JMP _0x6
; 0000 0028     PORTD=a[dong];
	MOVW R30,R16
	MOVW R26,R28
	ADIW R26,2
	LSL  R30
...
; 0000 002B     delay_ms(5);
	RCALL SUBOPT_0x0
; 0000 002C     if(PIND.4==0)
	SBIC 0x10,4
	RJMP _0x8
; 0000 002D     return key[dong][0];
	RCALL SUBOPT_0x1
	ADD  R26,R30
	ADC  R27,R31
	LD   R30,X
