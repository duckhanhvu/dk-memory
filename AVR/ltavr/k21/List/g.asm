...
; 0000 0036 PORTD=0b10000000;
	LDI  R30,LOW(128)
	OUT  0x12,R30
; 0000 0037 DDRD=0b00000000;
	LDI  R30,LOW(0)
	OUT  0x11,R30
; 0000 0038 
...
; 0000 0086 
; 0000 0087 
; 0000 0088         //if(!BUTTON)                // Neu BUTTON duoc an
; 0000 0089       //{
; 0000 008A           //delay_ms(10);          // Delay chong nhieu
; 0000 008B           if(!BUTTON)            // Neu dung BUTTON duoc an
	SBIC 0x10,7
	RJMP _0x6
; 0000 008C           {
; 0000 008D               PORTA=0b11111111;        // Trang thai cua LED duoc thay doi
	LDI  R30,LOW(255)
	RJMP _0x9
; 0000 008E               //while(!BUTTON);
; 0000 008F           }
; 0000 0090           else PORTA=0b00000000;
_0x6:
	LDI  R30,LOW(0)
_0x9:
	OUT  0x1B,R30
