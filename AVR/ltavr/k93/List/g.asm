...
_0x0:
	.DB  0x53,0x61,0x6E,0x67,0x54,0x61,0x6F,0x43
	.DB  0x6C,0x75,0x62,0x2E,0x4E,0x65,0x74,0x0
	.DB  0x54,0x65,0x73,0x74,0x20,0x4C,0x43,0x44
	.DB  0x20,0x66,0x6F,0x72,0x20,0x41,0x56,0x52
	.DB  0x0,0x30,0x31,0x32,0x33,0x34,0x35,0x36
	.DB  0x37,0x38,0x39,0x0,0x4F,0x4B,0x21,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0091 
; 0000 0092        lcd_init(16); //Khoi tao LCD 16x2
	LDI  R30,LOW(16)
	ST   -Y,R30
	RCALL _lcd_init
; 0000 0093        delay_ms(500); //Tao tre
	RCALL SUBOPT_0x0
; 0000 0094        lcd_puts("SangTaoClub.Net"); //Gui chuoi len LCD
	__POINTW1MN _0x3,0
	RCALL SUBOPT_0x1
; 0000 0095        delay_ms(1000);
	...
	LDI  R31,HIGH(1000)
	RCALL SUBOPT_0x2
; 0000 0096        lcd_clear(); //Xoa man hinh
	RCALL _lcd_clear
; 0000 0097        lcd_puts("Test LCD for AVR");
	__POINTW1MN _0x3,16
	RCALL SUBOPT_0x1
; 0000 0098        delay_ms(500);
	RCALL SUBOPT_0x0
; 0000 0099        lcd_gotoxy(0,1);//Tro toi vi tri dau tien dong 2
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R30,LOW(1)
	ST   -Y,R30
	RCALL _lcd_gotoxy
; 0000 009A        lcd_puts("0123456789");
	__POINTW1MN _0x3,33
	RCALL SUBOPT_0x1
; 0000 009B        delay_ms(500);
	RCALL SUBOPT_0x0
; 0000 009C        lcd_gotoxy(13,1);
	LDI  R30,LOW(13)
	ST   -Y,R30
	LDI  R30,LOW(1)
	ST   -Y,R30
	RCALL _lcd_gotoxy
; 0000 009D        lcd_puts("OK!");
	__POINTW1MN _0x3,44
	RCALL SUBOPT_0x1
; 0000 009E        while(1); //CPU stop
_0x4:
	RJMP _0x4
; 0000 009F }
_0x7:
