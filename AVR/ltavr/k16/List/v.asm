...
; 0000 0080 
; 0000 0081 
; 0000 0082 PORTA=0b00000000;
	OUT  0x1B,R30
; 0000 0083 DDRA=0b01111111;
	LDI  R30,LOW(127)
	OUT  0x1A,R30
; 0000 0084 
; 0000 0085 PORTC=0b00000000;
	LDI  R30,LOW(0)
	OUT  0x15,R30
; 0000 0086 DDRC=0b00000010;
	LDI  R30,LOW(2)
	OUT  0x14,R30
; 0000 0087 PINC=0b00000001;
	LDI  R30,LOW(1)
	OUT  0x13,R30
; 0000 0088 
; 0000 0089 if(PINC=0b00000000) {PORTA=0b00000110;}
	LDI  R30,LOW(0)
	OUT  0x13,R30
	CPI  R30,0
	BREQ _0x3
