...
; 0000 0027 void lCD_hienso(int n){
_lCD_hienso:
; 0000 0028 int i,a,temp,x;
; 0000 0029 //x = (dem_chuso(n)-1);
; 0000 002A temp = 1000;
	SBIW R28,2
	CALL __SAVELOCR6
;	n -> Y+8
...
;	x -> Y+6
	__GETWRN 20,21,1000
; 0000 002B for(i=0;i<(dem_chuso(n)+2);i++){
	__GETWRN 16,17,0
_0x7:
	LDD  R30,Y+8
	LDD  R31,Y+8+1
...
; 0000 002D  n=n%temp;
	...
	STD  Y+8,R30
	STD  Y+8+1,R31
; 0000 002E  temp=temp/10;
	MOVW R26,R20
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	CALL __DIVW21
	MOVW R20,R30
; 0000 002F lcd_putchar(a+48);
	MOV  R30,R18
	SUBI R30,-LOW(48)
	ST   -Y,R30
	CALL _lcd_putchar
...
; 0000 00AB       lcd_gotoxy(0,0);
	...
	ST   -Y,R30
	CALL _lcd_gotoxy
; 0000 00AC       lCD_hienso(4567);
	LDI  R30,LOW(4567)
	LDI  R31,HIGH(4567)
	ST   -Y,R31
	ST   -Y,R30
	RCALL _lCD_hienso
; 0000 00AD       //lcd_puts("khanh") ;
; 0000 00AE       }
	RJMP _0x9
; 0000 00AF }
_0xC:
