...
; 0000 0030 PORTC=0b00000011;;
	LDI  R30,LOW(3)
	OUT  0x15,R30
; 0000 0031 DDRC=0b00000011;
	OUT  0x14,R30
; 0000 0032 
...
; 0000 0086         PORTC=0b00000011;
	LDI  R30,LOW(3)
	OUT  0x15,R30
; 0000 0087         PORTC.0=0;
	CBI  0x15,0
; 0000 0088         PORTD=0b01011011;
	LDI  R30,LOW(91)
	RCALL SUBOPT_0x0
; 0000 0089         delay_ms(2);
; 0000 008A 
; 0000 008B         PORTC=0b00000011;
	LDI  R30,LOW(3)
	OUT  0x15,R30
; 0000 008C         PORTC.1=0;
	CBI  0x15,1
; 0000 008D         PORTD=0b01001111;
	LDI  R30,LOW(79)
	RCALL SUBOPT_0x0
; 0000 008E         delay_ms(2);
; 0000 008F 
; 0000 0090       }
	RJMP _0x3
; 0000 0091 }
