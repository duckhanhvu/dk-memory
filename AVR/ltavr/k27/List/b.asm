...
; 0000 002B unsigned char KEY4x4_Ispush(void){

	.CSEG
_KEY4x4_Ispush:
; 0000 002C if((KEY4x4_COL1==0)|(KEY4x4_COL2==0)|(KEY4x4_COL3==0)|(KEY4x4_COL4==0))
	LDI  R26,0
	SBIC 0x10,4
	LDI  R26,1
	LDI  R30,LOW(0)
...
; 0000 0030 void KEY4x4_checkROW(unsigned char i){
_KEY4x4_checkROW:
; 0000 0031 KEY4x4_ROW1 =KEY4x4_ROW2 =KEY4x4_ROW3 =KEY4x4_ROW4 =1;
;	i -> Y+0
	SBI  0x12,0
	SBI  0x12,1
	SBI  0x12,2
...
_0xE:
	...
	CPI  R26,LOW(0x1)
	BRNE _0x12
; 0000 0036     KEY4x4_ROW2=0;
	CBI  0x12,2
; 0000 0037 }
; 0000 0038 else if(i==2){
	RJMP _0x15
_0x12:
	LD   R26,Y
	CPI  R26,LOW(0x2)
	BRNE _0x16
; 0000 0039     KEY4x4_ROW3=0;
	CBI  0x12,1
; 0000 003A }
; 0000 003B else{
	RJMP _0x19
_0x16:
; 0000 003C     KEY4x4_ROW4=0;
	CBI  0x12,0
; 0000 003D }
_0x19:
_0x15:
...
; 0000 003F unsigned char KEY4x4_Getkey(void){
_KEY4x4_Getkey:
; 0000 0040 unsigned char i;
; 0000 0041 KEY4x4_ROW1=0;
	ST   -Y,R17
;	i -> R17
	CBI  0x12,3
; 0000 0042 KEY4x4_ROW2=0;
	CBI  0x12,2
; 0000 0043 KEY4x4_ROW3=0;
	CBI  0x12,1
; 0000 0044 KEY4x4_ROW4=0;
	CBI  0x12,0
; 0000 0045 if(KEY4x4_Ispush()){
	RCALL _KEY4x4_Ispush
	CPI  R30,0
	BREQ _0x24
; 0000 0046 //delay_ms(5);
; 0000 0047 if(KEY4x4_Ispush()){
	RCALL _KEY4x4_Ispush
	CPI  R30,0
	BREQ _0x25
...
_0x27:
	CPI  R17,4
	BRSH _0x28
; 0000 0049 KEY4x4_checkROW(i);
	ST   -Y,R17
	RCALL _KEY4x4_checkROW
; 0000 004A if(KEY4x4_COL1==0)  return KEY_4x4[i][0];
	SBIC 0x10,4
	RJMP _0x29
	RCALL SUBOPT_0x0
	ADD  R26,R30
	...
	LD   R30,X
	RJMP _0x2000001
; 0000 004B if(KEY4x4_COL2==0)  return KEY_4x4[i][1];
_0x29:
	SBIC 0x10,5
	RJMP _0x2A
	RCALL SUBOPT_0x0
	...
	LDD  R30,Z+1
	RJMP _0x2000001
; 0000 004C if(KEY4x4_COL3==0)  return KEY_4x4[i][2];
_0x2A:
	SBIC 0x10,6
	RJMP _0x2B
	RCALL SUBOPT_0x0
	...
	LDD  R30,Z+2
	RJMP _0x2000001
; 0000 004D if(KEY4x4_COL4==0)  return KEY_4x4[i][3];
_0x2B:
	SBIC 0x10,7
	RJMP _0x2C
	RCALL SUBOPT_0x0
...
; 0000 00CB       if(key==0){
	...
	CPI  R30,0
	BRNE _0x33
; 0000 00CC       key=KEY4x4_Getkey();
	RCALL SUBOPT_0x1
; 0000 00CD       PORTC=0b00001111;
; 0000 00CE       PORTC=0b00000111;
	LDI  R30,LOW(7)
	OUT  0x15,R30
; 0000 00CF       PORTA=key;
	LD   R30,Y
...
_0x33:
	...
	CPI  R26,LOW(0x1)
	BRNE _0x34
; 0000 00D2       key=KEY4x4_Getkey();
	RCALL SUBOPT_0x1
; 0000 00D3       PORTC=0b00001111;
; 0000 00D4       PORTC=0b00000011;
	LDI  R30,LOW(3)
	OUT  0x15,R30
; 0000 00D5       PORTA=key;
	LD   R30,Y
...
_0x34:
	...
	CPI  R26,LOW(0x2)
	BRNE _0x35
; 0000 00D8       key=KEY4x4_Getkey();
	RCALL SUBOPT_0x1
; 0000 00D9       PORTC=0b00001111;
; 0000 00DA       PORTC=0b00000001;
	LDI  R30,LOW(1)
	OUT  0x15,R30
; 0000 00DB       PORTA=key;
	LD   R30,Y
...
_0x35:
	...
	CPI  R26,LOW(0x3)
	BRNE _0x36
; 0000 00DE       key=KEY4x4_Getkey();
	RCALL SUBOPT_0x1
; 0000 00DF       PORTC=0b00001111;
; 0000 00E0       PORTC=0b00000000;
	LDI  R30,LOW(0)
	OUT  0x15,R30
; 0000 00E1       PORTA=key;
	LD   R30,Y
