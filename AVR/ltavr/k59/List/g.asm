...
;void truyendulieu(unsigned char chr){
; 0000 001E void truyendulieu(unsigned char chr){

	.CSEG
_truyendulieu:
; 0000 001F while((UCSRA==(0<<UDRE))){};//Kiem tra co UDRE
;	chr -> Y+0
_0x3:
	IN   R30,0xB
	CPI  R30,0
	BREQ _0x3
; 0000 0020 if((UCSRA==(1<<UDRE))){
	IN   R30,0xB
	CPI  R30,LOW(0x20)
	BRNE _0x6
; 0000 0021     UDR=chr;//Send 1 byte
	LD   R30,Y
	OUT  0xC,R30
; 0000 0022 }
; 0000 0023 }
...
; 0000 007A // USART Baud Rate: 57600
