...
_0x3:
	.DB  0x6,0x5B,0x4F,0x66,0x6D,0x7D,0x7,0x7F
	.DB  0x6F
_0x1F:
...
_quetled:
; 0000 002F   int j;
; 0000 0030   int x=0b00000111;
; 0000 0031   for(j=0;j<4;j++)
	CALL __SAVELOCR4
;	j -> R16,R17
;	x -> R18,R19
	__GETWRN 18,19,7
...
; 0000 003B unsigned char phat_hien_phim_nhan(void){
_phat_hien_phim_nhan:
; 0000 003C if((COL1==0)|(COL2==0)|(COL3==0)|(COL4==0))
	LDI  R26,0
	SBIC 0x10,4
	LDI  R26,1
	LDI  R30,LOW(0)
...
; 0000 0040 void xet_hang(unsigned char i){
_xet_hang:
; 0000 0041 ROW1=ROW2=ROW3=ROW4 =1;
;	i -> Y+0
	SBI  0x12,0
	SBI  0x12,1
	SBI  0x12,2
...
; 0000 0053 unsigned int Get_phimnhan(void){

	.CSEG
_Get_phimnhan:
; 0000 0054 unsigned char i;
; 0000 0055 ROW1=ROW2=ROW3=ROW4=0;
	ST   -Y,R17
;	i -> R17
	CBI  0x12,0
	CBI  0x12,1
	CBI  0x12,2
	CBI  0x12,3
; 0000 0056 if(phat_hien_phim_nhan()){
	RCALL _phat_hien_phim_nhan
	CPI  R30,0
	BREQ _0x28
; 0000 0057 delay_ms(5);
	...
	ST   -Y,R30
	CALL _delay_ms
; 0000 0058 if(phat_hien_phim_nhan()){
	RCALL _phat_hien_phim_nhan
	CPI  R30,0
	BREQ _0x29
; 0000 0059 for(i=0;i<4;i++){
	LDI  R17,LOW(0)
_0x2B:
	CPI  R17,4
	BRSH _0x2C
; 0000 005A xet_hang(i);
	ST   -Y,R17
	RCALL _xet_hang
; 0000 005B if(!COL1) return phimnhan_4x4[i][0];
	SBIC 0x10,4
	RJMP _0x2D
	RCALL SUBOPT_0x0
	ADD  R26,R30
	...
	LDI  R31,0
	RJMP _0x2000001
; 0000 005C if(!COL2) return phimnhan_4x4[i][1];
_0x2D:
	SBIC 0x10,5
	RJMP _0x2E
	RCALL SUBOPT_0x0
	...
	LDI  R31,0
	RJMP _0x2000001
; 0000 005D if(!COL3) return phimnhan_4x4[i][2];
_0x2E:
	SBIC 0x10,6
	RJMP _0x2F
	RCALL SUBOPT_0x0
	...
	LDI  R31,0
	RJMP _0x2000001
; 0000 005E if(!COL4) return phimnhan_4x4[i][3];
_0x2F:
	SBIC 0x10,7
	RJMP _0x30
	RCALL SUBOPT_0x0
...
; 0000 006E // Func7=In Func6=Out Func5=Out Func4=Out Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 006F // State7=T State6=0 State5=0 State4=0 State3=0 State2=0 State1=0 State0=0
; 0000 0070 PORTA=0x00;
	LDI  R30,LOW(0)
	OUT  0x1B,R30
; 0000 0071 DDRA=0b11111111;
	LDI  R30,LOW(255)
	OUT  0x1A,R30
; 0000 0072 
...
; 0000 007C PORTC=0b00001111;
	LDI  R30,LOW(15)
	OUT  0x15,R30
; 0000 007D DDRC=0b00001111;
	OUT  0x14,R30
; 0000 007E 
; 0000 007F // Port D initialization
; 0000 0080 // Func7=In Func6=In Func5=In Func4=In Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 0081 // State7=P State6=P State5=P State4=P State3=1 State2=1 State1=1 State0=1
; 0000 0082 PORTD=0xFF;
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 0083 DDRD=0x0F;
	LDI  R30,LOW(15)
...
SUBOPT_0x0:
	MOV  R30,R17
	LDI  R26,LOW(_phimnhan_4x4)
	LDI  R27,HIGH(_phimnhan_4x4)
	LDI  R31,0
	CALL __LSLW2
	RET
