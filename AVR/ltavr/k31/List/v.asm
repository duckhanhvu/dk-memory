...
_0x6:
	.DB  0xE,0x0,0x0,0x0,0x3F,0x0,0x6,0x0
	.DB  0x5B,0x0,0x4F,0x0
__RESET:
	CLI
	CLR  R30
	OUT  EECR,R30
...
; 0000 0086        int led_7[4]={0b00111111,0b00000110,0b01011011,0b01001111};
; 0000 0087        int i;
