...
; 0000 001E void USART_SendByte(unsigned char u8Data){

	.CSEG
_USART_SendByte:
; 0000 001F 
; 0000 0020   // Wait until last byte has been transmitted
...
_0x3:
	...
	RJMP _0x3
; 0000 0022 
; 0000 0023   // Transmit data
; 0000 0024   UDR = u8Data;
	LD   R30,Y
	OUT  0xC,R30
; 0000 0025 }
	ADIW R28,1
...
; 0000 007E // USART Baud Rate: 57600
; 0000 007F UCSRA=0x00;
	OUT  0xB,R30
; 0000 0080 UCSRB=0x08;
	LDI  R30,LOW(8)
	OUT  0xA,R30
...
; 0000 009B       //for(i=20;i<30;i++){
; 0000 009C       USART_SendByte(49);
	LDI  R30,LOW(49)
	ST   -Y,R30
	RCALL _USART_SendByte
