...
; 0000 0089        if(a==0)
	...
	SBIW R30,0
	BRNE _0x9
; 0000 008A         PORTA = 0b00000000;
	LDI  R30,LOW(0)
	RJMP _0x16
; 0000 008B        else
_0x9:
; 0000 008C         {PORTA = 0b11111111;}
	LDI  R30,LOW(255)
_0x16:
	OUT  0x1B,R30
...
; 0000 0091        if(b==0)
	...
	SBIW R30,0
	BRNE _0xE
; 0000 0092         PORTA = 0b01010101;
	LDI  R30,LOW(85)
	RJMP _0x17
; 0000 0093        else
_0xE:
; 0000 0094         {PORTA = 0b10101010;}
	LDI  R30,LOW(170)
_0x17:
	OUT  0x1B,R30
