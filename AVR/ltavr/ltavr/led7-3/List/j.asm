...
_0x6:
	.DB  0xD,0x0,0x7,0x0,0x8,0x0,0xE,0x0
...
; 0000 0022 // Func7=In Func6=Out Func5=Out Func4=Out Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 0023 // State7=T State6=0 State5=0 State4=0 State3=0 State2=0 State1=0 State0=0
...
; 0000 002E // Func7=In Func6=In Func5=In Func4=In Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 002F // State7=T State6=T State5=T State4=T State3=0 State2=0 State1=0 State0=0
...
; 0000 0086       char a[10]={0b01111110,0b00000110,0b01101101,0b01001111,0b00010111,0b01011011,0b01111011,0b00001110,0b01111111,0b01011111};
; 0000 0087       int y=0b00001110;
; 0000 0088       int x=0b00001000;
; 0000 0089       int z=0b00000111;
; 0000 008A       int g=0b00001101;
; 0000 008B       int i;
; 0000 008C       for(i=0;i<10;i++){
	SBIW R28,20
	LDI  R24,18
	LDI  R26,LOW(2)
	LDI  R27,HIGH(2)
