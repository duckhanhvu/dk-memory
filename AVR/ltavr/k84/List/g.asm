...
; 0000 004F // Clock source: T1 pin Falling Edge
; 0000 0050 // Mode: CTC top=ICR1
...
; 0000 0059 TCCR1A=0x00;
	OUT  0x2F,R30
; 0000 005A TCCR1B=(1<<ICNC1)|(1<<CS12);
	LDI  R30,LOW(132)
	OUT  0x2E,R30
