...
; 0000 001E  if (OCR1A==1000) OCR1A=1500;
	IN   R30,0x2A
	IN   R31,0x2A+1
	CPI  R30,LOW(0x3E8)
	LDI  R26,HIGH(0x3E8)
...
; 0000 004D // Mode: Fast PWM top=ICR1
...
; 0000 0056 TCCR1A=0x82;
	LDI  R30,LOW(130)
	OUT  0x2F,R30
; 0000 0057 TCCR1B=0x19;
	LDI  R30,LOW(25)
	OUT  0x2E,R30
...
; 0000 0059 TCNT1L=0x00;
	OUT  0x2C,R30
; 0000 005A ICR1H=0x4E;
	LDI  R30,LOW(78)
	OUT  0x27,R30
; 0000 005B ICR1L=0x20;
	LDI  R30,LOW(32)
	OUT  0x26,R30
; 0000 005C OCR1A=1000;
	LDI  R30,LOW(1000)
	LDI  R31,HIGH(1000)
	OUT  0x2A+1,R31
	OUT  0x2A,R30
...
; 0000 006C // INT0: On
; 0000 006D // INT0 Mode: Falling Edge
; 0000 006E // INT1: Off
; 0000 006F // INT2: Off
; 0000 0070 GICR|=0x40;
	IN   R30,0x3B
