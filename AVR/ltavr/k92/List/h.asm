...
_0x0:
	.DB  0x20,0x42,0x41,0x4E,0x4C,0x49,0x4E,0x48
	.DB  0x4B,0x49,0x45,0x4E,0x2E,0x56,0x4E,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 009A           lcd_gotoxy(0,1);
	...
	ST   -Y,R30
	RCALL _lcd_gotoxy
; 0000 009B           lcd_puts(" BANLINHKIEN.VN");
	__POINTW1MN _0x3,0
	ST   -Y,R31
	ST   -Y,R30
	RCALL _lcd_puts
