...
;void truyen_du_lieu(unsigned char chr){
; 0000 001E void truyen_du_lieu(unsigned char chr){

	.CSEG
_truyen_du_lieu:
; 0000 001F while (!( UCSRA & (1<<UDRE))){};
;	chr -> Y+0
_0x3:
	SBIS 0xB,5
	RJMP _0x3
...
; 0000 0094 
; 0000 0095 
; 0000 0096        truyen_du_lieu(0b10000001);
	LDI  R30,LOW(129)
	ST   -Y,R30
	RCALL _truyen_du_lieu
