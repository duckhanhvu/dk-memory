...
; 0000 0086         PORTC=0b00001111;
	LDI  R30,LOW(15)
	OUT  0x15,R30
; 0000 0087         PORTC=0b00001110;
	LDI  R30,LOW(14)
	OUT  0x15,R30
; 0000 0088         PORTA=0b00000110;
	LDI  R30,LOW(6)
	RCALL SUBOPT_0x0
; 0000 0089         delay_ms(1);
; 0000 008A         //PORTC=0b00001111;
; 0000 008B 
; 0000 008C         PORTC=0b00001111;
; 0000 008D         PORTC=0b00001101;
	LDI  R30,LOW(13)
	OUT  0x15,R30
; 0000 008E         PORTA=0b01011011;
	LDI  R30,LOW(91)
	RCALL SUBOPT_0x0
; 0000 008F         delay_ms(1);
; 0000 0090         //PORTC=0b00001111;
; 0000 0091 
; 0000 0092         PORTC=0b00001111;
; 0000 0093         PORTC=0b00001011;
	LDI  R30,LOW(11)
	OUT  0x15,R30
; 0000 0094         PORTA=0b01001111;
	LDI  R30,LOW(79)
	RCALL SUBOPT_0x0
; 0000 0095         delay_ms(1);
; 0000 0096         //PORTC=0b00001111;
; 0000 0097 
; 0000 0098         PORTC=0b00001111;
; 0000 0099         PORTC=0b00000111;
	LDI  R30,LOW(7)
	OUT  0x15,R30
; 0000 009A         PORTA=0b01100110;
	LDI  R30,LOW(102)
	OUT  0x1B,R30
