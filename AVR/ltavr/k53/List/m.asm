...
; 0000 002D void lCD_hienso(unsigned int n){
_lCD_hienso:
; 0000 002E unsigned int m=0,a;
; 0000 002F while(n!=0){
	CALL __SAVELOCR4
;	n -> Y+4
;	m -> R16,R17
...
; 0000 009A // ADC Auto Trigger Source: Analog Comparator
...
; 0000 009D ADMUX=ADC_VREF_TYPE & 0xff;
	LDI  R30,LOW(96)
	OUT  0x7,R30
; 0000 009E ADCSRA=0xA4;
	LDI  R30,LOW(164)
	OUT  0x6,R30
; 0000 009F SFIOR&=0x1F;
	IN   R30,0x30
	ANDI R30,LOW(0x1F)
	OUT  0x30,R30
; 0000 00A0 SFIOR|=0x20;
	IN   R30,0x30
	ORI  R30,0x20
	OUT  0x30,R30
; 0000 00A1 
