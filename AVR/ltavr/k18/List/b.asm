...
; 0000 0023 // State7=T State6=1 State5=1 State4=1 State3=1 State2=1 State1=1 State0=1
; 0000 0024 PORTA=0b00000000;
	LDI  R30,LOW(0)
	OUT  0x1B,R30
; 0000 0025 DDRA=0x7F;
	LDI  R30,LOW(127)
...
; 0000 0028 // Func7=In Func6=In Func5=In Func4=In Func3=In Func2=In Func1=Out Func0=In
; 0000 0029 // State7=T State6=T State5=T State4=T State3=T State2=T State1=1 State0=P
; 0000 002A PORTB=0b00000001;
	LDI  R30,LOW(1)
	OUT  0x18,R30
; 0000 002B DDRB=0b00000000;
	LDI  R30,LOW(0)
	OUT  0x17,R30
; 0000 002C 
...
; 0000 0030 PORTC=0b00000000;
	OUT  0x15,R30
; 0000 0031 DDRC=0b00000001;
	LDI  R30,LOW(1)
	OUT  0x14,R30
; 0000 0032 
...
_0x3:
; 0000 0084       {
; 0000 0085         if(PORTB==0b00000000){
	IN   R30,0x18
	CPI  R30,0
	BRNE _0x6
; 0000 0086         PORTA=0b00000110;
	LDI  R30,LOW(6)
	RCALL SUBOPT_0x0
; 0000 0087         delay_ms(10);
; 0000 0088         PORTA=0b00000000;
	LDI  R30,LOW(0)
	RCALL SUBOPT_0x0
