...
;
;
;//ham hien thi gia tri phim an ra led7
;void show_led7(unsigned int number){
; 0000 002D void show_led7(unsigned int number){
...
; 0000 0032 b=number%10;
	...
	MOVW R18,R30
; 0000 0033 
; 0000 0034  PORTC=0b00000011;
	LDI  R30,LOW(3)
	OUT  0x15,R30
; 0000 0035  PORTC=0b00000010;
	LDI  R30,LOW(2)
	OUT  0x15,R30
; 0000 0036  PORTA= led_7[a];
...
; 0000 0038 
; 0000 0039  PORTC=0b00000011;
; 0000 003A  PORTC=0b00000001;
	LDI  R30,LOW(1)
	OUT  0x15,R30
; 0000 003B  PORTA= led_7[b];
	LDI  R26,LOW(_led_7_G000)
	LDI  R27,HIGH(_led_7_G000)
	ADD  R26,R18
	ADC  R27,R19
...
; 0000 0040 unsigned char KEY4x4_Ispush(void){
_KEY4x4_Ispush:
; 0000 0041 if((KEY4x4_COL1==0)|(KEY4x4_COL2==0)|(KEY4x4_COL3==0)|(KEY4x4_COL4==0))
	LDI  R26,0
	SBIC 0x10,4
	LDI  R26,1
	LDI  R30,LOW(0)
...
; 0000 0045 void KEY4x4_checkROW(unsigned char i){
_KEY4x4_checkROW:
; 0000 0046 KEY4x4_ROW1 =KEY4x4_ROW2 =KEY4x4_ROW3 =KEY4x4_ROW4 =1;
;	i -> Y+0
	SBI  0x12,0
	SBI  0x12,1
	SBI  0x12,2
...
; 0000 0047 if(i==0){
	...
	CPI  R30,0
	BRNE _0xE
; 0000 0048     KEY4x4_ROW1=0;
	CBI  0x12,3
; 0000 0049 }
; 0000 004A else if(i==1){
	RJMP _0x11
_0xE:
	LD   R26,Y
	CPI  R26,LOW(0x1)
	BRNE _0x12
; 0000 004B     KEY4x4_ROW2=0;
	CBI  0x12,2
; 0000 004C }
; 0000 004D else if(i==2){
	RJMP _0x15
_0x12:
	LD   R26,Y
	CPI  R26,LOW(0x2)
	BRNE _0x16
; 0000 004E     KEY4x4_ROW3=0;
	CBI  0x12,1
; 0000 004F }
; 0000 0050 else{
	RJMP _0x19
_0x16:
; 0000 0051     KEY4x4_ROW4=0;
	CBI  0x12,0
; 0000 0052 }
_0x19:
_0x15:
...
;                              13,14,15,16};
	...
	.DSEG
;unsigned char KEY_4x4_Getkey(void){
; 0000 0058 unsigned char KEY_4x4_Getkey(void){

	.CSEG
_KEY_4x4_Getkey:
; 0000 0059 
; 0000 005A unsigned char i;
; 0000 005B KEY4x4_ROW1=0;
	ST   -Y,R17
;	i -> R17
	CBI  0x12,3
; 0000 005C KEY4x4_ROW2=0;
	CBI  0x12,2
; 0000 005D KEY4x4_ROW3=0;
	CBI  0x12,1
; 0000 005E KEY4x4_ROW4=0;
	CBI  0x12,0
; 0000 005F if(KEY4x4_Ispush()){
	RCALL _KEY4x4_Ispush
	CPI  R30,0
	BREQ _0x25
; 0000 0060 //delay_ms(5);
; 0000 0061 if(KEY4x4_Ispush()){
	RCALL _KEY4x4_Ispush
	CPI  R30,0
	BREQ _0x26
; 0000 0062 for(i=0;i<4;i++){
	LDI  R17,LOW(0)
_0x28:
	CPI  R17,4
	BRSH _0x29
; 0000 0063 KEY4x4_checkROW(i);
	ST   -Y,R17
	RCALL _KEY4x4_checkROW
; 0000 0064 if(KEY4x4_COL1==0)  return KEY_4x4[i][0];
	SBIC 0x10,4
	RJMP _0x2A
	RCALL SUBOPT_0x1
	ADD  R26,R30
	...
	LD   R30,X
	RJMP _0x2000001
; 0000 0065 if(KEY4x4_COL2==0)  return KEY_4x4[i][1];
_0x2A:
	SBIC 0x10,5
	RJMP _0x2B
	RCALL SUBOPT_0x1
	...
	LDD  R30,Z+1
	RJMP _0x2000001
; 0000 0066 if(KEY4x4_COL3==0)  return KEY_4x4[i][2];
_0x2B:
	SBIC 0x10,6
	RJMP _0x2C
	RCALL SUBOPT_0x1
	...
	LDD  R30,Z+2
	RJMP _0x2000001
; 0000 0067 if(KEY4x4_COL4==0)  return KEY_4x4[i][3];
_0x2C:
	SBIC 0x10,7
	RJMP _0x2D
	RCALL SUBOPT_0x1
...
; 0000 007B // Func7=In Func6=Out Func5=Out Func4=Out Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 007C // State7=T State6=0 State5=0 State4=0 State3=0 State2=0 State1=0 State0=0
...
; 0000 0089 PORTC=0b00000011;
	LDI  R30,LOW(3)
	OUT  0x15,R30
; 0000 008A DDRC=0b00000011;
	OUT  0x14,R30
; 0000 008B 
; 0000 008C // Port D initialization
; 0000 008D // Func7=In Func6=In Func5=In Func4=In Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 008E // State7=P State6=P State5=P State4=P State3=1 State2=1 State1=1 State0=1
; 0000 008F PORTD=0xFF;
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 0090 DDRD=0x0F;
	LDI  R30,LOW(15)
...
_0x2E:
; 0000 00DD       {
; 0000 00DE        unsigned char key;
; 0000 00DF        unsigned int number;
; 0000 00E0        key=KEY_4x4_Getkey();
	SBIW R28,3
;	key -> Y+2
;	number -> Y+0
	RCALL _KEY_4x4_Getkey
	STD  Y+2,R30
; 0000 00E1        if(key){
	CPI  R30,0
	BREQ _0x31
; 0000 00E2        number=key;
	LDI  R31,0
	ST   Y,R30
	STD  Y+1,R31
; 0000 00E3        show_led7(number);
	ST   -Y,R31
	ST   -Y,R30
	RCALL _show_led7
; 0000 00E4        }
