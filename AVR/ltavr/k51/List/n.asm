...
; 0000 001F void lCD_hienso(unsigned int n){

	.CSEG
_lCD_hienso:
; 0000 0020 //lcd_gotoxy(0,0);
; 0000 0021 unsigned int m=0,a,b,i;
...
; 0000 0098 // RS - PORTD Bit 0
; 0000 0099 // RD - PORTD Bit 1
; 0000 009A // EN - PORTD Bit 2
; 0000 009B // D4 - PORTD Bit 4
; 0000 009C // D5 - PORTD Bit 5
; 0000 009D // D6 - PORTD Bit 6
; 0000 009E // D7 - PORTD Bit 7
